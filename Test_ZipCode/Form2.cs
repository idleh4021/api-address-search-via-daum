    ...
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //string url = Application.StartupPath + @"\index.html";
        ...
        private void wb_size()
        {
            try
            {
                ...
                if(w>0 && h > 0) { lfn_Cshap_WEB_initLayerPosition(w, h); }
            }
            catch(Exception ex)
            {
                Base_Message(ex);
        ...
        //WEB -> C#
        public void lfn_WEB_Cshap_Script2( object obj01, object obj02, object obj03, object obj04, object obj05, object obj06, object obj07, object obj08, object obj09,
                                           object obj10, object obj11, object obj12, object obj13, object obj14, object obj15, object obj16, object obj17, object obj18, 
                                           object obj19, object obj20, object obj21, object obj22, object obj23, object obj24, object obj25, object obj26, object obj27, object obj28, object obj29, object obj30, object obj31, object obj32, object obj33)
        {
            try
            {
                #region "변수선언"
                ...
                dr["autoJibunAddress"] = val14;
                dr["autoJibunAddressEnglish"] = val15;

                dr["buildingCode"] = val16;
                ...
                try
                {
                    ...
                    {
                        strADDR1 = dr["jibunAddress"].ToString(); // 사용자가 지번 주소를 선택했을 경우
                    }
        ...
        private void lfn_dr(ref DataRow dr)
        {
            try
            {
                ...
                dt.Columns.Add("autoJibunAddress");
                dt.Columns.Add("autoJibunAddressEnglish");

                dt.Columns.Add("buildingCode");
        ...
        {
            webBrowser1.Document.InvokeScript("initLayerPosition", new object[] { w, h });//웹 자바스크립트에 전달
        }
        ...
        private void lfn_Cshap_WEB_Script2()
        {
            ...
            webBrowser1.Document.InvokeScript("Cshap_WEB_Script2", new object[] { str1, str2 });//웹 자바스크립트에 전달
        ...
        public void Base_Message(string message)
        {
